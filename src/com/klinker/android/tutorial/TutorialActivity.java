...
public class TutorialActivity extends Activity {
    ...
    // actions to do in the background as different states are firing
    public static final String ACTION_1_1 = "com.klinker.android.tutorial.BUBBLE_1_STEP_1";
    public static final String ACTION_1_2 = "com.klinker.android.tutorial.BUBBLE_1_STEP_2";
    public static final String ACTION_2_1 = "com.klinker.android.tutorial.BUBBLE_2_STEP_1";
    public static final String ACTION_2_2 = "com.klinker.android.tutorial.BUBBLE_2_STEP_2";
    ...
    // defines all of the drawing on the screen for the bubbles
    private class DrawingPanel extends SurfaceView implements
        ...
        public void surfaceCreated(SurfaceHolder holder) {
            ...
            // define all of the circles to show on the screen
            circles = new Circle[]{
                    new Circle(circle1,
                            .3,
                            .95,
        ...
        public boolean onTouchEvent(MotionEvent event) {
            // check if a bubble has been touched in the correct state, and if so change the state
        ...
        // update everything based on the current state and advance when necessary
        public void update() {
            switch (state) {
                case STATE_LOADING:
                ...
                case STATE_B1_W:
                    ...
                    if (time - startTime > 5000) {
                        ...
                        sendBroadcast(new Intent(ACTION_1_1));
                        needOpenDrawer = false;
                    } else if (time - startTime > 3000 && needCloseDrawer) {
                        sendBroadcast(new Intent(ACTION_1_2));
                ...
                case STATE_B2_W:
                    ...
                    if (time - startTime > 5000) {
                        ...
                        sendBroadcast(new Intent(ACTION_2_1));
                        needPageRight = false;
                    } else if (time - startTime > 3000 && needPageLeft) {
                        sendBroadcast(new Intent(ACTION_2_2));
                        needPageLeft = false;
                    }
        ...
        // draw everything on the screen that should be applied to the view
        ...
        // some calculus magic got me this equation for the radius changing over time
        private double getRadiusNeeded(Circle circle) {
            ...
            // formula for adjusting radius based on the time that i want
    ...
    // game thread controlling the fps and keeping a consistent drawing look
